...
NetworkRoutines:DisconnectNetworkDrive, MapNetworkDrive,GetUserName,GetUNCPath,etc.
...
**Archive File**   |[](https://github.com/Planet-Source-Code/newsgroup-posting-networkroutines__1-583/archive/master.zip)
